...
await p.screenshot({ path: `${OUT}/sconce-entry-N.png`, timeout: 180000 })
await p.getByRole('button', { name: /Doors/ }).click({ force: true })
await p.waitForTimeout(3000)
await p.screenshot({ path: `${OUT}/sconce-entry-N-open.png`, timeout: 180000 })
